...
type HousingSearchWarrantMenuProps = {
    data?: ApartmentMenuData;
};

export const HousingSearchWarrantMenu: FunctionComponent<HousingSearchWarrantMenuProps> = ({ data }) => {
    if (!data) {
        return null;
    }
                ...
                <MenuContent>
                    {data.apartments.map(apartment => {
                        return (
                            <MenuItemButton
                                onConfirm={() => {
                                    fetchNui(NuiEvent.HousingSearchWarrantUse, {
