...
const licenses: Record<DrivingSchoolLicenseType, DrivingSchoolLicense> = {
    ...
    [DrivingSchoolLicenseType.Boat]: {
        licenseType: DrivingSchoolLicenseType.Boat,
        vehicle: {
            model: 'squalo',
            spawnPoints: [
                ...
                [-786.75, -1398.65, 0.0, 229.64],
                [-792.99, -1407.09, 0.0, 233.82],
                [-798.35, -1413.12, 0.0, 222.84],
            ],
        },
        price: 270,
        ...
        marker: markers.landVehicle,
        checkpointCount: 5,
        finalCheckpoint: finalCheckpoints.boatVehicle,
    },
};
...
export const Checkpoints: Checkpoint[] = [
    ...
    { coords: [-1986.2, -2678.73, 0.0], licenses: [DrivingSchoolLicenseType.Boat] },
    { coords: [-297.91, -2338.16, 0.0], licenses: [DrivingSchoolLicenseType.Boat] },
    { coords: [663.57, -1858.29, 8.5], licenses: [DrivingSchoolLicenseType.Boat] },
    { coords: [1289.3, -2962.45, 0.0], licenses: [DrivingSchoolLicenseType.Boat] },
