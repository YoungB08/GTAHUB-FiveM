...
export enum VehicleCategory {
    ...
    Compacts = 'Xe nhỏ gọn (Compacts)',
    Coupes = 'Xe Coupes 2 cửa',
    Cycles = 'Xe đạp',
    Emergency = 'Xe khẩn cấp (Cứu thương/Cảnh sát)',
    Helicopters = 'Máy bay trực thăng',
    Industrial = 'Xe công nghiệp',
    Military = 'Xe quân sự',
    Motorcycles = 'Xe máy',
    Muscle = 'Xe cơ bắp (Muscle)',
    'Off-road' = 'Xe địa hình (Off-road)',
    Openwheel = 'Xe đua F1 (Open-wheel)',
    Planes = 'Máy bay',
    Sedans = 'Xe 4 chỗ (Sedans)',
    Service = 'Xe dịch vụ',
    Sportsclassics = 'Xe thể thao cổ điển',
    Sports = 'Xe thể thao',
    Super = 'Siêu xe (Supercars)',
    Suvs = 'Xe gầm cao (SUV)',
    Trains = 'Tàu hỏa',
    Utility = 'Xe tiện ích / Chuyên dụng',
    Vans = 'Xe Van chở hàng',
    Electric = 'Xe điện',
    Quads = 'Xe địa hình 4 bánh (Quads)',
}
...
export const LockPickAlertMessage = {
    all: [
        'Trong ${0}, nó cố kéo ${1}, ngay trước mặt tôi! Ngay đó!',
        "Lại một kẻ ăn bám khác đang cố gắng ngủ ấm áp tối nay tại ${0}, nhưng ${1} này không phải của anh ấy",
        'BORDEL MA CAISSE ! ON ME VOLE MA ${1} ! JE SUIS PROCHE DE ${0} !',
        "Chào! Trước mặt tôi có trộm một chiếc ${1}, nhanh tay đến với ${0} nhé!",
        "Nhưng bạn đang ở đâu?! Ai đó đang đánh cắp ${1} xung quanh ${0}!",
    ],
    carjack: [
        "Tôi vừa bị cướp xe! Nhưng vâng, xe của tôi đã bị cướp, tôi nói cho bạn biết! Điều này đã xảy ra tại ${0}, ${1}!",
    ],
    lockpick: ["Một kẻ mờ ám đang nghịch tay cầm của chiếc ${1} gần ${0}!"],
};
